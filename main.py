#CÓDIGO PARA SALVAR UM ÚNICO USUÁRIO EM UM ARQUIVO JSON
...
while True:
    ...
    # ---------------------------
    # 3️ Buscar usuário por nome (parcial)
    # ---------------------------
    elif opcao == 3:
